...
namespace BGHAmbulance.Controllers
{
    ...
    public class AmbulancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,AmbName,AmbNo,AmbMake,AmbModel,AmbDriver,AmbUpadtedBy,AmbUpdatedOn")] Ambulance ambulance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,AmbName,AmbNo,AmbMake,AmbModel,AmbDriver,AmbUpadtedBy,AmbUpdatedOn")] Ambulance ambulance)
        {
            if (ModelState.IsValid)
            {
